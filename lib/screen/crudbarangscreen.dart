...
class CrudPageBarang extends StatefulWidget {
  CrudPageBarang({Key? key}) : super(key: key);

  @override
  State<CrudPageBarang> createState() => _CrudPageBarangState();
}

class _CrudPageBarangState extends State<CrudPageBarang> {
